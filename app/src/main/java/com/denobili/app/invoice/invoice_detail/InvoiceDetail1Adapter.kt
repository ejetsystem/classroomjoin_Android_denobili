...
class InvoiceDetail1Adapter (var objects: List<DisplayItem>? = ArrayList<DisplayItem>(), context: Context) : BaseRecyclerviewAdapter<DisplayItem>(objects) {
    ...
    init {
        ...
        delegatesManager.addDelegate(InvoiceDAdapter1Delegate(context))
    }
