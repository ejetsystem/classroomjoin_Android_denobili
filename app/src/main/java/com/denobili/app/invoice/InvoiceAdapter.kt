...
class InvoiceAdapter(var objects: List<DisplayItem>? = ArrayList<DisplayItem>(), context: Context, userId: String, orgId: String?) : BaseRecyclerviewAdapter<DisplayItem>(objects) {
    ...
    init {
        ...
        delegatesManager.addDelegate(InvoiceAdapterDelegate(context,userId,orgId))
    }
