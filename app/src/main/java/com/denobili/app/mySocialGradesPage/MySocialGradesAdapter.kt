...
class MySocialGradesAdapter(var objects: List<DisplayItem>?=ArrayList<DisplayItem>()) : BaseRecyclerviewAdapter<DisplayItem>(objects) {
    ...
    init {
        ...
        delegatesManager.addDelegate(MySocialGradesAdapterDelegate())
    }
