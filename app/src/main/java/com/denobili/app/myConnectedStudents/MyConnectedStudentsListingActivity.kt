...
import com.denobili.app.studentCodePage.InputStudentCode
import com.denobili.app.studentHomePage.Student_Home_Activity
...
*/
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        if (item!!.itemId == android.R.id.home) {
            ...
            startActivity(Intent(this@MyConnectedStudentsListingActivity, LandingActivity::class.java).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP))
            finishAffinity()
        }
        return true
    }
