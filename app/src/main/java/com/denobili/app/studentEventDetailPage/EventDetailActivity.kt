...
var sharedPreferenceData:SharedPreferencesData?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*sharedPreferenceData=SharedPreferencesData(this)
        var diaryCount=sharedPreferenceData!!.DiaryCount
        if (EVENT_TYPE_ID_KEY.equals("2"))
        {
            sharedPreferenceData!!.saveDiaryCount((diaryCount!!.toInt()-1))
            sharedPreferenceData!!.saveDiary((diaryCount!!.toInt()-1).toString())
        }else{}*/
