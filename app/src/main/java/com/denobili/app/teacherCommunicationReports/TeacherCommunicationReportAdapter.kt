...
class TeacherCommunicationReportAdapter(var objects: List<DisplayItem>? = ArrayList<DisplayItem>(), var contect:Context)
    ...
    init {
        ...
        delegatesManager.addDelegate(TeacherCommunicationReportAdapterDelegate(contect))
    }
