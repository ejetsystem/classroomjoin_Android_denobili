...
class TemplateSelectionCommunicationAdapterDelegate(listener:TemplateSelectionListener) : AdapterDelegate<List<DisplayItem>>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup): RecyclerView.ViewHolder {
        val view= LayoutInflater.from(viewGroup.context).inflate(R.layout.row_template_selction_2,viewGroup,false)
