...
public abstract class BaseListActivity extends LocalizationActivity implements SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG ="BaseActivity" ;
    private BaseRecyclerviewAdapter adapter;
    private RecyclerView recyclerView;
    private TouchDetectableScrollView nestedScrollView;
    ...
    public TouchDetectableScrollView getNestedScrollView() {
        return nestedScrollView;
    }

    public void setNestedScrollView(TouchDetectableScrollView nestedScrollView) {
    ...
    public void initviews(){
        ...
        setRecyclerView((RecyclerView) findViewById(R.id.recycler_home));
        setNestedScrollView((TouchDetectableScrollView) findViewById(R.id.nested));

        getRecyclerView().setLayoutManager(new LinearLayoutManager(this));
        setSwipeContainer((SwipeRefreshLayout)findViewById(R.id.include_content));
        getSwipeContainer().setOnRefreshListener(this);
        setImageView((ImageView)findViewById(R.id.base_home_image));
        setTextView((TextView)findViewById(R.id.base_home_textview));
        setContentLoadingProgressBar((ContentLoadingProgressBar)findViewById(R.id.contentLoading));
