...
import com.denobili.app.emailSettingPage.EmailSettingPage
...
import com.denobili.app.mySocialGradesPage.MySocialGradesListingActivity
import com.denobili.app.profilePage.ProfilePage
import com.denobili.app.smsCommunicationSettingPage.MessageCommunicationSettingPage
import com.denobili.app.smsCommunicationSettingPage.SmsCommunicationSettingPage
import com.denobili.app.splashPage.LanguageSelectionActivity
import com.denobili.app.teacherAddClasses.ClassListFragment
import com.denobili.app.teacherOutboxPage.OutboxModel
import com.denobili.app.teacherOutboxPage.Outboxpage
import com.denobili.app.teacherReportPage.TeacherReportPage
import com.denobili.app.templatePage.TemplateSelectionPage
...
class HomePage : LocalizationActivity(), NavigationView.OnNavigationItemSelectedListener,
    ...
    fun logout() {
        ...
        startActivity(Intent(this@HomePage, LandingActivity::class.java).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP))
        finishAffinity()
    }
}
