...
import com.denobili.app.slide_login.LoginMainActivty
...
import kotlinx.android.synthetic.main.activity_account_option.*
...
class AccountOption : AppCompatActivity() ,View.OnClickListener,GoogleApiClient.OnConnectionFailedListener{
   ...
   var  mGoogleApiClient: GoogleApiClient?=null;
    ...
    override fun onClick(v: View?) {
        when(v?.getId()) {
            ...
            R.id.close->
            closeActivity()
            R.id.sign_in_google->signIn()
            //Comment for Denobili
           /* R.id.signUpBtn->
    ...
    private fun signEmail() {
        intent = Intent(this, LoginMainActivty::class.java)
        startActivity(intent)
    }
