...
import com.denobili.app.mystudentsPage.Sortbyname
import com.denobili.app.mystudentsPage.Sortbyroll
import com.denobili.app.postAttendancePage.checkAttendance.AttendanceMicroEvent
import com.denobili.app.postAttendancePage.checkAttendance.AttendanceMicroModel
import com.denobili.app.postAttendancePage.checkAttendance.AttendanceMicroPresenter
import com.denobili.app.teacherOutboxPage.Outboxpage
import com.denobili.app.templatePage.Template
...
class AttendenceSelectionListingActivity : BaseListActivity(), AnkoLogger {
    ...
    var USER_NAME: String = "com.classroom.setting.username"
    ...
    private fun sendAttendence() {
        ...
        presenter!!.postdata(PostAttendence(currentDateTimeString, getSelecteditems(),
                ...
                templateDataPresentSubject,templateDatePresentText,"",user_name ))
