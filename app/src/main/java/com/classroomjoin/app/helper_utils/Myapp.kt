...
import com.classroomjoin.app.components.ApiInterfaceComponent
import com.classroomjoin.app.components.DaggerApiInterfaceComponent
import com.classroomjoin.app.components.DaggerApplicationComponent
...
class Myapp : Application(), AnkoLogger {
    ...
    override fun onCreate() {
        ...
        Shaky.with(this, EmailShakeDelegate("g.peddiraju93@gmail.com"))
        ...
        remoteConfigDefaults.put(ForceUpdateChecker.KEY_UPDATE_URL,
                "https://play.google.com/store/apps/details?id=com.classroomjoin.app")
