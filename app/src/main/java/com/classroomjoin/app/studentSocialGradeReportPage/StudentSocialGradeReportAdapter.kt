...
class StudentSocialGradeReportAdapter(var objects: List<DisplayItem>? = ArrayList<DisplayItem>()) : BaseRecyclerviewAdapter<DisplayItem>(objects) {
    ...
    init {
        ...
        delegatesManager.addDelegate(SocialGradeChartAdapterDelegate())
        delegatesManager.addDelegate(StudentSocialGradeAdapterDelegate())
