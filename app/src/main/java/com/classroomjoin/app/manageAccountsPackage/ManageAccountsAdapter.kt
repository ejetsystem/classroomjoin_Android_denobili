...
class ManageAccountsAdapter(var objects: List<DisplayItem>? = ArrayList<DisplayItem>(), context: Context) : BaseRecyclerviewAdapter<DisplayItem>(objects) {
    ...
    init {
        ...
        delegatesManager.addDelegate(ManageAccountsAdapterDelegate(context))
    }
